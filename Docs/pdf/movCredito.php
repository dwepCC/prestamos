...
$sell=new Sell();
$rspta=$sell->mostrarMovimiento($idcredito);
...
$bloque3 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<td style="border: 1px solid #666; background-color:white; width:85px; text-align:center">F. Cuota</td>
		<td style="border: 1px solid #666; background-color:white; width:75px; text-align:center">Interes</td>
		<td style="border: 1px solid #666; background-color:white; width:80px; text-align:center">Capital</td>
		<td style="border: 1px solid #666; background-color:white; width:90px; text-align:center">Total</td>
		<td style="border: 1px solid #666; background-color:white; width:100px; text-align:center">F. Registro</td>
<td style="border: 1px solid #666; background-color:white; width:45px; text-align:center">Pago</td>
...
$interes=$key['interes_original'];
$capital=$key['capital_original'];
$total_pago=$key['total_pago_original'];
$fecha_reg=$key['fecha_pago'];
/*if($key['credito_estado']==1){
    $estado='OK';
}else {
    $estado='';
}*/
$estado=($key['credito_estado'])?'OK':'';
$bloque4 = <<<EOF
	...
	<table style="font-size:10px; padding:0px 0px;">
      ...
      $fecha_reg
			...
			<td style="border: 1px solid #666; color:#23972F; background-color:white; width:45px; text-align:center">
      $estado
			</td>
