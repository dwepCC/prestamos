        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4>Registro de ingresos <button class="btn btn-success" onclick="mostrarform(true)" id="btnagregar"><i
...
require "footer.php";
?>
<script src="Views/modules/scripts/ingreso.js"></script>
<?php
 }
  ob_end_flush();
  ?>