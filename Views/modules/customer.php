                                ...
                                <form action="" name="formulario" id="formulario" method="POST">
                                    <div class="row">
                                        <div class="form-group col-lg-4 col-md-4 col-xs-12">
                                            ...
                                            <input class="form-control" type="text" name="ap" id="ap" maxlength="100"
                                                placeholder="Apellido paterno" onkeyup="mayus(this);" required>
                                        </div>

                                        <div class="form-group col-lg-4 col-md-4 col-xs-12">
                                            <label for="">Apellido materno(*)</label>
                                            <input class="form-control" type="text" name="am" id="am" maxlength="100"
                                                placeholder="Apellido materno" onkeyup="mayus(this);" required>
                                        </div>

                                        <div class="form-group col-lg-4 col-md-4 col-xs-12">
                                            <label for="">Nombre(*)</label>
                                            <input class="form-control" type="text" name="nombre" id="nombre"
                                                maxlength="100" placeholder="Nombre del cliente" onkeyup="mayus(this);"
                                                required>
                                        </div>
                                        ...
                                        <div class="form-group col-lg-4 col-md-4 col-xs-12">
                                            ...
                                            <input class="form-control" type="number" name="num_documento"
                                        ...
                                        <div class="form-group col-lg-4 col-md-4 col-xs-12">
                                            ...
                                            <input class="form-control" type="text" name="direccion" id="direccion"
                                                maxlength="70" placeholder="Direccion" onkeyup="mayus(this);">
                                        </div>
                                        ...
                                        <div class="form-group col-lg-4 col-md-4 col-xs-12">
                                            ...
                                            <input class="form-control" type="email" name="email" id="email"
                                                maxlength="50" placeholder="Email" onkeyup="minus(this);">
                                        </div>
