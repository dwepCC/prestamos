                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <h4 class="box-title">Lista de préstamos
                                <?php 
                                if($_SESSION['generaSolicitudCredito']==1){
                                    ?>
                                <button class="btn btn-primary" id="btnagregar"><i class="fa fa-plus-circle"></i>
                                    Nuevo crédito</button>
                                <?php
                                }
                             ?>
                            </h4>
                            <label class="btn btn-success">Vigente:
                                <input type="radio" name="estadoCredito" value="Aprobado" checked>
                            </label>
                            <label class="btn btn-warning">Desaprobado:
                                <input type="radio" name="estadoCredito" value="Desaprobado">
                            </label>
                            <label class="btn btn-danger">Cancelado:
                                <input type="radio" name="estadoCredito" value="Anulado">
                            </label>
                        </div>
